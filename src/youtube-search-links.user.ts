...
function makeLink(providerName: string, baseUrl: string) {
...
function getTitleEl() {
	const el1 = document.querySelector('h1 .ytd-video-primary-info-renderer') as HTMLElement | null;
	const el2 = document.querySelector('h1 .ytd-watch-metadata') as HTMLElement | null;
	return (isVisible(el1) && el1) || (isVisible(el2) && el2);
}

function isVisible(elem: HTMLElement | null): boolean {
